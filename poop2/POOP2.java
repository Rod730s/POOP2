...
public class POOP2 {
    ...
    public static void main(String[] args) {
        ...
        char vocal = 'a';
        switch (vocal) {
            case 'a' -> System.out.println("Elegiste la vocal A");
            case 'e' -> System.out.println("Elegiste la vocal E");
            case 'i' -> System.out.println("Elegiste la vocal I");
            case 'o' -> System.out.println("Elegiste la vocal O");
            case 'u' -> System.out.println("Elegiste la vocal U");
            default -> System.out.println("No elegiste una vocal");
        }
